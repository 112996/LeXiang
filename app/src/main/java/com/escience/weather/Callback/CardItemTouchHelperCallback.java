package com.escience.weather.Callback;
...
public class CardItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    private OnSwipeListener<Object> mListener;

    public CardItemTouchHelperCallback(@NonNull RecyclerView.Adapter adapter, @NonNull ArrayList<BaseItem> dataList) {
        this.adapter = adapter;
        this.dataList = dataList;
    }

    public CardItemTouchHelperCallback(@NonNull RecyclerView.Adapter adapter, @NonNull ArrayList<BaseItem> dataList, OnSwipeListener<Object> listener) {
        this.adapter = adapter;
        this.dataList = dataList;
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if(!dataList.isEmpty()) {
            Object remove = dataList.remove(layoutPosition);
    ...
    public void setOnSwipedListener(OnSwipeListener<Object> mListener) {
