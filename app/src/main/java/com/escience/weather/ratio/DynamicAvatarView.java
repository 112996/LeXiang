...
public class DynamicAvatarView extends ImageView {
    ...
    private static final int DEFAULT_BORDER_COLOR = Color.parseColor("#55FFFFFF");
    private static final int OUTER_PAINT_COLOR = Color.parseColor("#33FFFFFF");
    private static final int INNER_PAINT_COLOR = Color.parseColor("#44FFFFFF");
    private static final int OUTER_PAINT_COLOR_CENTER = Color.parseColor("#11FFFFFF");
    private static final int INNER_PAINT_COLOR_CENTER = Color.parseColor("#22FFFFFF");
