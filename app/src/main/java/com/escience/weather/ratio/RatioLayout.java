package com.escience.weather.ratio;
...
public class RatioLayout extends ViewGroup {
    ...
    private com.escience.weather.ratio.DynamicAvatarView mImageView;

    //private boolean mIsFinishFirst;

    private List<com.escience.weather.ratio.BubbleView> mTextViews = new ArrayList<>();
...
//    }
    ...
    *//**
    ...
    public List<com.escience.weather.ratio.BubbleView> getTextViews(){
        return mTextViews;
    }
     ...
     * @param textViews
     */
    public void startBubbleFloat(List<com.escience.weather.ratio.BubbleView> textViews){
...
//        }
     ...
     * 中间圆外围圈进入完成监听
     */
    private com.escience.weather.ratio.DynamicAvatarView.EnterFinishListener mEnterFinishListener = new com.escience.weather.ratio.DynamicAvatarView.EnterFinishListener() {
        @Override
        ...
        public void firstEnterFinish() {
            ...
            mAnimatorEnetr = ValueAnimator.ofObject(new com.escience.weather.ratio.EnterRatioFrameEvaluator(getContext()), getRatioFrameCenterList(mRatioFrameCenter,mRatioFrameList),mRatioFrameList);
